var Form = require('../acrobat/form'),
    ...
    layoutAdjust = require('../i18n/layout-adjust').bind('aurebesh'),
    abilityId = 0,
    customSkillId = 0,
    dutyBoxId = 0,
    critLineId = 0;
...
_.extend(exports, require('../base/factory'), {
    ...
    description: function (s) {
        var a = layoutAdjust.bind(['description']);
        ...
        return this.component({
            ...
            y: s.y,
            children: [
                this.text(a.extend(['species'], {
                    name: 'species',
                    defaultValue: 'Human'
                }, s.species || {})),
                this.text(a.extend(['career'], { name: 'career' }, s.career || {})),
                this.text(a.extend(['gender'], { name: 'gender' }, s.gender || {})),
                this.text(a.extend(['age'], { name: 'age' }, s.age || {} )),
                this.text(a.extend(['height'], { name: 'height' }, s.height || {} )),
                this.text(a.extend(['build'], { name: 'build' }, s.build || {})),
                this.text(a.extend(['hair'], { name: 'hair' }, s.hair || {})),
                this.text(a.extend(['eyes'], { name: 'eyes' }, s.eyes || {})),
                this.text(a.extend(['motivation1'], { name: 'motivation1', }, s.motivation1 || {})),
                this.text(a.extend(['motivation2'], { name: 'motivation2', }, s.motivation2 || {}))
            ]
        });
    },
