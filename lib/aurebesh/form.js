...
_.extend(require('../base/text').prototype.defaults, {
    color: colors.cmyk(0, 0, 0, 70),
    size: 8,
    font: font.Helv
});

_.extend(require('../base/check-box').prototype.defaults, {
    color: colors.cmyk(0, 0, 0, 70),
    size: 8,
    font: font.Helv
});
...
// doc.addScript('fixupForm', Aurebesh.script(function () {
//     var len, i, f;
// 
//     if (app.viewerVersion >= 11) {
//         for (i = 0, len = this.numFields; i < len; i++) {
